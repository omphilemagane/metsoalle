...
module.exports = async (request, response) => {
    ...
    record["chat-id"] = await new Promise((resolve, reject) => {
    ...
    await new Promise((resolve, reject) => {
        fs.mkdir("/home/" + record["account-id"] + "/chats/" + record["chat-id"] + "/", (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });

    await new Promise((resolve, reject) => {
        fs.writeFile("/home/" + record["account-id"] + "/chats/" + record["chat-id"] + "/index.json", JSON.stringify(record, null, 4), (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });

    await new Promise((resolve, reject) => {
        fs.mkdir("/home/" + record["account-id"] + "/chats/" + record["chat-id"] + "/messages/", (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });

    await new Promise((resolve, reject) => {
        fs.mkdir("/home/" + record["foreign-id"] + "/chats/" + record["chat-id"] + "/", (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });

    await new Promise((resolve, reject) => {
        fs.symlink("/home/" + record["account-id"] + "/chats/" + record["chat-id"] + "/index.json", "/home/" + record["foreign-id"] + "/chats/" + record["chat-id"] + "/index.json", (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });

    await new Promise((resolve, reject) => {
        fs.mkdir("/home/" + record["foreign-id"] + "/chats/" + record["chat-id"] + "/messages/", (error) => {
            return error == null ? resolve() : reject(new Error(error["message"]));
        });
    });
